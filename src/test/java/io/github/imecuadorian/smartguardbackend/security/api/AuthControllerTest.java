...
class AuthControllerTest {
    ...
    @Test
    void registerClientIsPublicAndReturnsSession() throws Exception {
        when(authService.registerClient(any(RegisterClientRequest.class))).thenReturn(new AuthResponse(
                "Bearer",
                "access-token",
                "refresh-token",
                60,
